/*
  Add magnetic guidelines to the canvas editor
*/
...
export class GuidelinePlugin {
    ...
    init(canvas) {
        ...
        function drawVerticalLine(coords) {
            drawLine(coords.x1 + 0.5, coords.y1 > coords.y2 ? coords.y2 : coords.y1, coords.x1 + 0.5, coords.y2 > coords.y1 ? coords.y2 : coords.y1);
        }
        function drawHorizontalLine(coords) {
            drawLine(coords.x1 > coords.x2 ? coords.x2 : coords.x1, coords.y1 + 0.5, coords.x2 > coords.x1 ? coords.x2 : coords.x1, coords.y1 + 0.5);
        }
        ...
        canvas.on('object:moving', function (e) {
            ...
            let activeObjectCenter = activeObject.getCenterPoint(), activeObjectLeft = activeObjectCenter.x, activeObjectTop = activeObjectCenter.y, activeObjectBoundingRect = activeObject.getBoundingRect(), activeObjectHeight = activeObjectBoundingRect.height / viewportTransform[3], activeObjectWidth = activeObjectBoundingRect.width / viewportTransform[0], horizontalInTheRange = false, verticalInTheRange = false, transform = canvas.viewportTransform;
            if (!transform)
                return;
